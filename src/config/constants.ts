...
export const SEVERITY_OPTIONS: SeverityOption[] = [
    { id: 'Fully Accessible', label: 'Fully Accessible', level: 'fully_accessible', color: 'fullyAccessible', icon: '' },
    { id: 'Partially Accessible', label: 'Partially Accessible', level: 'partially_accessible', color: 'partiallyAccessible', icon: '' },
    { id: 'Limited Accessibility', label: 'Limited Accessibility', level: 'limited_accessibility', color: 'limitedAccessibility', icon: '' },
    { id: 'Not Accessible', label: 'Not Accessible', level: 'not_accessible', color: 'notAccessible', icon: '' },
    { id: 'Unknown Accessibility', label: 'Unknown', level: 'unknown_accessibility', color: 'unknownAccessibility', icon: '' },
];
