...
function Button({ onPress, label, variant = 'primary', disabled = false, style, textStyle }: ButtonProps) {
    ...
    return (
        <TouchableOpacity style={[s.button, style]} onPress={onPress} disabled={disabled}>
